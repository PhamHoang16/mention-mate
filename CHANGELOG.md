...
### Added
- **Distribution pipeline**: GitHub Actions workflow builds multi-arch Docker image (linux/amd64 + linux/arm64) and publishes to `ghcr.io/hoangp47/mentionmate` on every `v*.*.*` tag push.
...
[Unreleased]: https://github.com/hoangp47/mentionmate/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/hoangp47/mentionmate/releases/tag/v0.1.0
