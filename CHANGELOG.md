...
### Added
- **Distribution pipeline**: GitHub Actions workflow builds multi-arch Docker image (linux/amd64 + linux/arm64) and publishes to `ghcr.io/phamhoang16/mention-mate` on every `v*.*.*` tag push.
...
[Unreleased]: https://github.com/PhamHoang16/mention-mate/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/PhamHoang16/mention-mate/releases/tag/v0.1.0
